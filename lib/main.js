...
// 'wgsl_prefix' imports
import * as convert_gray_prefix_wgsl from "./wgsl_prefix/convert_gray_prefix.wgsl?raw";
import * as depth_buffer_wgsl from "./wgsl_prefix/depth_buffer.wgsl?raw";
import * as panel_buffer_wgsl from "./wgsl_prefix/panel_buffer.wgsl?raw";
import * as volume_frame_wgsl from "./wgsl_prefix/volume_frame.wgsl?raw";
import * as volume_intercepts_wgsl from "./wgsl_prefix/volume_intercepts.wgsl?raw";
// 'wgsl_suffix' imports
import * as Painter_wgsl from "./wgsl_suffix/Painter.wgsl?raw";
import * as combine_depth_buffers_wgsl from "./wgsl_suffix/combine_depth_buffers.wgsl?raw";
import * as convert_buffer_wgsl from "./wgsl_suffix/convert_buffer.wgsl?raw";
import * as convert_depth_buffer_wgsl from "./wgsl_suffix/convert_depth_buffer.wgsl?raw";
import * as depth_buffer_range_wgsl from "./wgsl_suffix/depth_buffer_range.wgsl?raw";
import * as embed_volume_wgsl from "./wgsl_suffix/embed_volume.wgsl?raw";
import * as index_colorize_wgsl from "./wgsl_suffix/index_colorize.wgsl?raw";
import * as max_value_project_wgsl from "./wgsl_suffix/max_value_project.wgsl?raw";
import * as mix_color_panels_wgsl from "./wgsl_suffix/mix_color_panels.wgsl?raw";
import * as mix_depth_buffers_wgsl from "./wgsl_suffix/mix_depth_buffers.wgsl?raw";
import * as mix_dots_on_panel_wgsl from "./wgsl_suffix/mix_dots_on_panel.wgsl?raw";
import * as normal_colors_wgsl from "./wgsl_suffix/normal_colors.wgsl?raw";
import * as paste_panel_wgsl from "./wgsl_suffix/paste_panel.wgsl?raw";
import * as soften_volume_wgsl from "./wgsl_suffix/soften_volume.wgsl?raw";
import * as threshold_wgsl from "./wgsl_suffix/threshold.wgsl?raw";
import * as volume_at_depth_wgsl from "./wgsl_suffix/volume_at_depth.wgsl?raw";
