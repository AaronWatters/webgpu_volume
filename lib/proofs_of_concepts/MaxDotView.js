...
// This proof of concept version supports dot annotations on the output panel.
...
export class Max extends viewVolume.View {
    ...
    panel_sequence(context) {
        ...
        const max_dots = 1000;
        this.dots_action = new MixDotsOnPanel.MixDotsOnPanel(
            this.grey_panel,
            max_dots,
        )
        this.dots_action.attach_to_context(context);
