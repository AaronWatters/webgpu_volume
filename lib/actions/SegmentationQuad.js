...
export class SegmentationQuad extends viewVolume.View {
    ...
    async change_volumes(segmentationCPUBuffer, intensityCPUBuffer) {
        //debugger;
        this.segmentationVolume.set_data(segmentationCPUBuffer.data);
        this.segmentationVolume.push_buffer();
        this.intensityVolume.set_data(intensityCPUBuffer.data);
        this.intensityVolume.push_buffer();
        this.run();
    };
