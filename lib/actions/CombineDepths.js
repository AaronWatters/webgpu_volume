...
// xxxx this should be refactored as subclass of UpdateAction.
...
import combine_depth_buffers from "../wgsl_suffix/combine_depth_buffers.wgsl?raw";
...
export class CombineDepths extends GPUAction.Action {
    constructor (outputDB, inputDB, offset_ij, sign) {
        ...
        // by default the input dominates if at a a lower depth.
        this.sign = sign || 1;
