...
// xxxx should refactor and unify projection parameters somehow.
export class MaxProjectionParameters extends GPUDataObject.DataObject {
    constructor (
        ...
        // matrix + 3 sets of 4 float intersection parameters + probe
