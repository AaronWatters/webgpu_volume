...
async function do_pipeline_async(canvas, from_fn, kSlider, kValue) {
    ...
    //var ijk2xyz_in = qdVector.MM_product(
    //    qdVector.affine3d(initial_rotation),
    //    qdVector.affine3d(null, [-K/2, -J/2, -I/2])
    //)
    ...
    //    [0, 0, 0, 1],
    //];
    //const rotate_out = qdVector.affine3d(initial_rotation, null)
    //const ijk2xyz_out = qdVector.MM_product(rotate_out, translate_out);
    //const ijk2xyz_out = translate_out;
